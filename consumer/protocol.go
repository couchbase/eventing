...
func (c *Consumer) makeV8InitPayload(appName, debuggerPort, currHost, eventingDir, eventingPort,
	...
	skipLcbBootstrap bool, curlTimeout int64, timerContextSize int) (encodedPayload []byte, builder *flatbuffers.Builder) {
	builder = c.getBuilder()
	...
	payload.PayloadAddTimerContextSize(builder, int32(timerContextSize))

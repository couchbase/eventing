...
func (parseInfo *ParseInfo) FlattenParseInfo(urlValues *url.Values) {
	urlValues.Add("is_valid", Bool10(parseInfo.IsValid))
	urlValues.Add("is_select_query", Bool10(parseInfo.IsSelectQuery))
	urlValues.Add("is_dml_query", Bool10(parseInfo.IsDmlQuery))

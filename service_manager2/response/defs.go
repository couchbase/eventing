...
func (r *RuntimeInfo) Convert(errInfo *ErrorInfo) {
	if errInfo == nil {
		r.ErrCode = ErrInternalServer
		return
	}

	r.Description = errInfo.Description
	r.ErrCode = errCode(errInfo.Code)
}
...
var (
	eventMap = map[eventCode]*event{
		...
		EventStartDebugger: &event{
			...
			systemLogId: common.EVENTID_START_DEBUGGER,
		},
		...
		EventStopDebugger: &event{
			...
			systemLogId: common.EVENTID_STOP_DEBUGGER,
		},
		...
		EventCleanupEventing: &event{
			...
			systemLogId: common.EVENTID_CLEANUP_EVENTING,
		},
		...
		EventDie: &event{
			...
			systemLogId: common.EVENTID_DIE,
		},
		...
		EventTriggerGC: &event{
			...
			systemLogId: common.EVENTID_TRIGGER_GC,
		},
		...
		EventFreeOSMemory: &event{
			...
			log:         AuditLog | SystemLog,
			auditLogVal: auditevent.EventingSystemEvent,
			systemLogId: common.EVENTID_FREE_OS_MEMORY,
		},
		...
		EventCreateFunction: &event{
			...
			systemLogId: common.EVENTID_CREATE_FUNCTION,
		},
		...
		EventDeleteFunction: &event{
			...
			systemLogId: common.EVENTID_DELETE_FUNCTION,
		},
		...
		EventClearStats: &event{
			...
			systemLogId: common.EVENTID_CLEAR_STATISTICS,
		},
		...
		EventImportFunctions: &event{
			...
			systemLogId: common.EVENTID_IMPORT_FUNCTIONS,
		},
		...
		EventExportFunctions: &event{
			...
			systemLogId: common.EVENTID_EXPORT_FUNCTIONS,
		},
		...
		EventBackupFunctions: &event{
			...
			systemLogId: common.EVENTID_BACKUP_FUNCTION,
		},
		...
		EventRestoreFunctions: &event{
			...
			systemLogId: common.EVENTID_RESTORE_FUNCTION,
		},

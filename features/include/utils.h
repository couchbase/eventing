...
public:
  ...
  UrlEncode UrlEncodePath(const std::string& path, const std::string& curl_lang_compat);
  UrlEncode UrlEncodeParams(const v8::Local<v8::Value> &val, const std::string& curl_lang_compat);

private:
  UrlEncode UrlEncodeStringParams(const std::string& qry_params, const std::string& curl_lang_compat);
